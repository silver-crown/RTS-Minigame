...
//            }
        ...
        //Just the same as qToAxexXY, but Y is main here (Y don't changes direction and X used only for Z calculation)
...
//            return q;
        ...
        public static Vector3 torqueFromQuaternions(Quaternion currentRot, Quaternion wantedRot, Vector3 currentRotSpeed, float angleToSpeed, float speedDifToAccel, float dt) {
            ...
            if (rotSub.w < 0) rotSub = rotSub.scale(-1); //big jump without it eventually
