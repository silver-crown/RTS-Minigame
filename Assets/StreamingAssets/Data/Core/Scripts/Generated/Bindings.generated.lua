...
UI.SetFont = function(id__Int32, path__String) end
...
Drone.SetStatus = function(status__String) end
...
DroneStaticMethods.AddInventoryComponent = function(id__Int32, capacity__Int32) end
DroneStaticMethods.AddMinerComponent = function(id__Int32) end
RTSLuaManager = {}
