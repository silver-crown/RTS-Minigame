...
namespace Bbbt
{
    ...
    [CreateAssetMenu(fileName = "Flank Target Behind", menuName = "bbBT/Behaviour/Leaf/Flank Target Behind", order = 0)]
    ...
    public class BbbtFlankTargetBehind : BbbtLeafBehaviour
    {
        ...
        public override string SaveDataType { get; } = "BbbtFlankTargetBehind";
        ...
        {
            int angle = 180;
            //attack the target force from behind
            ...
            //if you're not behind, get behind.
